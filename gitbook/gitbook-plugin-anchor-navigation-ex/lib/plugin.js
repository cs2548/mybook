...
function handlerFloatNavbar($, tocs) {
    ...
    for (var i = 0; i < tocs.length; i++) {
        var h1Toc = tocs[i];
        if (h1Toc.name){
            html += "<li><span class='title-icon " + level1Icon + "'></span><a href='#" + h1Toc.url + "'>" + h1Toc.name + "</a></li>";
        }
        if (h1Toc.children.length > 0) {
            ...
            for (var j = 0; j < h1Toc.children.length; j++) {
                ...
                if(h2Toc.name){
                    html += "<li><span class='title-icon " + level2Icon + "'></span><a href='#" + h2Toc.url + "'>" + h2Toc.name + "</a></li>";
                }
                if (h2Toc.children.length > 0) {
                    html += "<ul>";
                    for (var k = 0; k < h2Toc.children.length; k++) {
                        var h3Toc = h2Toc.children[k];
                        html += "<li><span class='title-icon " + level3Icon + "'></span><a href='#" + h3Toc.url + "'>" + h3Toc.name + "</a></li>";
                    }
                    html += "</ul>";
                }
            }
